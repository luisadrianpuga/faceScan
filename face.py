...
ENDPOINT = "https://faceluispuga.cognitiveservices.azure.com/"
...
faces = face_client.face.detect_with_stream(image, detection_model='detection_01', recognition_model='recognition_01')#, return_face_attributes=['qualityForRecognition'])
for face in faces:
